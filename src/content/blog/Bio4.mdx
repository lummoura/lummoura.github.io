...
category: 'Bio'
tags: ['project management', professional experience', 'CT', 'ZIKA', 'AI', 'Machine Learning', 'Deep Learning', 'leadership', 'Agile']
---

# From Academia to Agile
...
### Congenital Zika Syndrome - [CZS](https://www.cdc.gov/zika/czs/index.html) is no joke. 
...
While there are tons of tools available to analyze MRI images, the same cannot be said for CT scans. We found ourselves developing new tools from scratch to tackle this gap.
