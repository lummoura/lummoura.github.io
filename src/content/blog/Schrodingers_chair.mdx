...
Picture 1. Timeline of patterns with both components active. “Who” couplings are omitted due to persistently weak pairing in the dataset.
...
Picture 2. Co-occurrence matrix of components. The pale periphery of “who” indicates weak participation relative to what, how, and value.
Across all 55 business-model patterns and their exemplary companies: the strongest co-occurrences are what–value (222), what–how (196), and how–value (177). Together, these form the dense triangle that dominates the network. “Who” has far fewer links (e.g., 24 with “how,” 40 with “what”).
...
Traditional innovation assumes segments. Personalized healthcare assumes singulars.
...
Customer identity is sticky. Distribution, brand, compliance, and partnerships are built around known customers. Switching “who” forces costly rewiring across the system.
...
Personalization in healthcare makes “who” a design variable, not a background assumption.
“Who” can be a different payer (employer, insurer, foundation), a different orchestrator (patient organization, registry, data trust), or a different decision agent (departmental buyer, workflow bot, compliance gateway). Most importantly, “who” can be an individual patient whose definition—and thus value—changes as new evidence arrives. This is why the revolution is more complex than expected. We aren’t just adding genomics to old pathways. We are moving the only piece that the last century left untouched.
Why this matters for startups
The last century avoided the very dimension a startup must solve first. Personalized healthcare flips the logic to who–proof–pay.
